  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        className="h-5 w-5"
      >
        <path d="M21.5 11.2c.2-.5.3-1 .3-1.5 0-1.8-1.5-3.3-3.3-3.3-.9 0-1.7.4-2.3 1-1.3-.9-2.9-1.4-4.7-1.5l1-3.1 2.7.6c.1 1 1 1.7 2 1.5 1-.2 1.7-1.1 1.5-2.1-.2-1-1.1-1.7-2.1-1.5-.6.1-1.1.5-1.3 1l-3.1-.7c-.4-.1-.8.1-.9.5L10 5.9c-1.8.1-3.5.6-4.8 1.5-.6-.6-1.4-1-2.3-1C1.1 6.4-.4 7.9-.4 9.7c0 .5.1 1 .3 1.5-.3.5-.4 1.1-.4 1.8 0 3.7 4.8 6.7 10.7 6.7s10.7-3 10.7-6.7c0-.7-.1-1.3-.4-1.8ZM6.5 12.4c0-.9.7-1.6 1.6-1.6s1.6.7 1.6 1.6S9 14 8.1 14s-1.6-.7-1.6-1.6Zm9.9 3.1c-1.2 1.2-3.1 1.8-5.3 1.8s-4.1-.6-5.3-1.8c-.2-.2-.2-.6 0-.8.2-.2.6-.2.8 0 1 .9 2.6 1.4 4.5 1.4s3.5-.5 4.5-1.4c.2-.2.6-.2.8 0 .2.2.2.6 0 .8Zm-.5-1.5c-.9 0-1.6-.7-1.6-1.6s.7-1.6 1.6-1.6 1.6.7 1.6 1.6-.7 1.6-1.6 1.6Z" />
      </svg>
    ),
  },
];
...
export default function Footer() {
  return (
    <footer className="bg-background">
      ...
      {/* Social / Intro Bar */}
          <div className="-mt-px border-t border-b border-border">   {/* ← margen negativo y bordes separados */}
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col gap-6 py-10 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="max-w-xl text-sm leading-6 text-muted">
                    RIKITECH - Software downloads, drivers and technology content.
                  </p>
                </div>
                <div className="flex items-center gap-5">
                  {socialLinks.map((social) => (
                    <Link key={social.name} href={social.href} aria-label={social.name} className="text-muted transition-colors hover:text-foreground">
                      {social.icon}
                    </Link>
                  ))}
                </div>
